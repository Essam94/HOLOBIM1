...
public class MiniMap : Singleton<MiniMap>
{
    ...
    void Update()
    {
         transitionProgress = (Time.realtimeSinceStartup - transitionStartTime) / transitionTime;
    ...
    public float transitionStartTime = float.MinValue;
    public Vector3 transitionStartPosition = Vector3.zero;
    public Vector3 transitionStartScale = Vector3.one;
    public float transitionStartLineWidth;
