...
public class MeshAnalyzer : Singleton<MeshAnalyzer>
{
    ...
    public int numberOfPlanesToDisplay = 10;
    ...
    private void Update()
    {
        ...
        if (displayFoundWalls && state == State.Finished)
       {
           ...
           this.InstructionTextMesh.text = string.Format("Mesh Analysis Done.");
    ...
    {
        this.InstructionTextMesh.text = string.Format("Starting mesh analysis");
